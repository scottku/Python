...
def get_datetime():
    ...
    # 생성자 이용, 직접 날짜 지정
    dt = datetime.datetime(1972, 11, 21) # 최소 년월일은 지정
    print(dt)
    ...
    print("오늘은 {}요일 입니다.".format(now.weekday()))
...
def timedelta_ex():
    ...
    print("현재 시간: ", current)
    past = datetime.datetime(1972, 11, 21)
    print("과거 시간: ", past)
    ...
    # 현재 시간에서 100일 후 정보
    diff = datetime.timedelta(100, 0, 0) # 100일 0초 0마이크로초
    print("현재 시간으로부터 100일 후: ", current + diff)

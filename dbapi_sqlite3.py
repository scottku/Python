...
def test_search_data(db_file):
    ...
    #   플레이스 홀더에 :키로 명명
    #   데이터는 dict로 전달
    sql = """ SELECT name, category, region FROM customer 
